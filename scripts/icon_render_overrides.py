...
def main():
 ...
 for key in ("applepay","googlepay","unionpay"):
  ...
  for size in (64,128,256):
   rel=pngs.get(str(size)) or f"png/{size}/{key}.png";dest=ICON_ROOT/rel;dest.parent.mkdir(parents=True,exist_ok=True);cairosvg.svg2png(bytestring=data,write_to=str(dest),output_width=size,output_height=size)
