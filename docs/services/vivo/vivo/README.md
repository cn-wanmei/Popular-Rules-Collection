...
| Icon Identity | `brand.vivo` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **vivo 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/vivo/vivo/vivo.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/vivo/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `vivo_aggregate` / vivo | 服务集 / Provider 聚合 | 14 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/vivo/README.md) |
| `vivo` / vivo | 独立服务 | 14 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/vivo/vivo/README.md) |
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/vivo.png" alt="vivo icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `f09ccbbc7330d5c8a095503625e7a477049a98f86dfd664346d32b7a78e7f2cc` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/vivo.png) |
