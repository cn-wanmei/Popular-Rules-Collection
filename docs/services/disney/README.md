...
这是 **Disney 服务集的聚合规则**，用于一次覆盖该服务集当前已登记的相关规则。需要更精确分流时，应直接使用下方独立子服务，而不是手工拆分聚合文件。
...
当前规则文件：
```text
rule/disney/disney.yaml
```

这是顶级服务集 **disney** 的入口，共 3 个已登记规则条目。
