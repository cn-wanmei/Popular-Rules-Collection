...
| Icon Identity | `brand.zhihu` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **Zhihu 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/zhihu/zhihu/zhihu.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/zhihu/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `zhihu_aggregate` / Zhihu | 服务集 / Provider 聚合 | 7 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/zhihu/README.md) |
| `zhihu` / Zhihu | 独立服务 | 7 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/zhihu/zhihu/README.md) |
...
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/zhihu/zhihu/zhihu.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/zhihu/zhihu/zhihu.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/zhihu/zhihu/zhihu.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/zhihu/zhihu/zhihu.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/zhihu/zhihu/zhihu.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/zhihu/zhihu/zhihu.list`
...
rule-providers:
  zhihu:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/zhihu/zhihu/zhihu.yaml"
    path: ./ruleset/zhihu.yaml
    interval: 86400

rules:
  - RULE-SET,zhihu,PROXY
```
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/zhihu.png" alt="Zhihu icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `537a6c335a4fdc1d6b4297cd1d57940e9d6fa7774aa12ccbacb861408b3fb780` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/zhihu.png) |
