...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="Developer Ecosystem 图标" width="72" height="72">
...
这是 **Developer Ecosystem** 的分类规则集，具体匹配范围以当前规则文件为准。
...
当前规则文件：
```text
rule/category/developer/developer.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/category/README.md)
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="Developer Ecosystem icon" width="56" height="56">
