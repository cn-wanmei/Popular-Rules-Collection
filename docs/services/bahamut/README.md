...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="Bahamut 图标" width="72" height="72">
...
这是 **Bahamut 服务集的聚合规则**，用于一次覆盖该服务集当前已登记的相关规则。需要更精确分流时，应直接使用下方独立子服务，而不是手工拆分聚合文件。
...
当前规则文件：
```text
rule/bahamut/bahamut.yaml
```

这是顶级服务集 **bahamut** 的入口，共 2 个已登记规则条目。

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `bahamut_aggregate` / Bahamut | 服务集 / Provider 聚合 | 7 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/bahamut/README.md) |
| `bahamut` / Bahamut | 独立服务 | 7 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/bahamut/bahamut/README.md) |
...
- **egern**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/egern/bahamut/bahamut.yaml`
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/bahamut/bahamut.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/bahamut/bahamut.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/bahamut/bahamut.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/bahamut/bahamut.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/bahamut/bahamut.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/bahamut/bahamut.list`
...
rule-providers:
  bahamut_aggregate:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/bahamut/bahamut.yaml"
    path: ./ruleset/bahamut_aggregate.yaml
    interval: 86400

rules:
  - RULE-SET,bahamut_aggregate,PROXY
```
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="Bahamut icon" width="56" height="56">
