...
| Icon Identity | `semantic.chinamobile` |
| Icon Role | `special` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **China Mobile 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/chinamobile/chinamobile/chinamobile.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/chinamobile/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `chinamobile_aggregate` / China Mobile | 服务集 / Provider 聚合 | 38 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/chinamobile/README.md) |
| `chinamobile` / China Mobile | 独立服务 | 38 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/chinamobile/chinamobile/README.md) |
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/chinamobile.png" alt="China Mobile icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `d0e3b2a0742b6f32c19f90f1fdd944f3421d79fcb141b735ee6dd76868a2411f` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/chinamobile.png) |
