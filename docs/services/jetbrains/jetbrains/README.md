...
| 规则浏览路径 | `jetbrains/jetbrains/jetbrains.yaml` |
| 语义规则数量 | **25** |
...
| Icon Identity | `brand.jetbrains` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **JetBrains 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/jetbrains/jetbrains/jetbrains.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/jetbrains/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `jetbrains_aggregate` / JetBrains | 服务集 / Provider 聚合 | 25 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/jetbrains/README.md) |
| `jetbrains` / JetBrains | 独立服务 | 25 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/jetbrains/jetbrains/README.md) |
...
- **egern**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/egern/jetbrains/jetbrains/jetbrains.yaml`
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/jetbrains/jetbrains/jetbrains.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/jetbrains/jetbrains/jetbrains.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/jetbrains/jetbrains/jetbrains.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/jetbrains/jetbrains/jetbrains.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/jetbrains/jetbrains/jetbrains.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/jetbrains/jetbrains/jetbrains.list`
...
rule-providers:
  jetbrains:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/jetbrains/jetbrains/jetbrains.yaml"
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/jetbrains.png" alt="JetBrains icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `a4177164adb32fabd7fb361c998d141d7f0c05ca91c7286849d662e582c4bc11` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/jetbrains.png) |
