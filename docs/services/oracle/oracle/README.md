...
| Icon Identity | `brand.oracle` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **Oracle 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/oracle/oracle/oracle.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/oracle/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `oracle_aggregate` / Oracle | 服务集 / Provider 聚合 | 27 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/oracle/README.md) |
| `oracle` / Oracle | 独立服务 | 27 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/oracle/oracle/README.md) |
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/oracle.png" alt="Oracle icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `87cfa17000cd44818cf4c003eb10fcd612c16997e7b39df1a1f28dabf63810b8` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/oracle.png) |
