...
| Icon Identity | `brand.microsoft` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **Microsoft 服务集的聚合规则**，用于一次覆盖该服务集当前已登记的相关规则。需要更精确分流时，应直接使用下方独立子服务，而不是手工拆分聚合文件。
...
当前规则文件：
```text
rule/microsoft/microsoft.yaml
```

这是顶级服务集 **microsoft** 的入口，共 5 个已登记规则条目。
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/microsoft.png" alt="Microsoft icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `06118455adfd5a732c466eee495948ffd0149ad144ce239d3d0cf0f60aab6ca6` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/microsoft.png) |
