...
| 类型 | 独立服务 |
| Provider / 服务集 | `ookla` |
| 规则浏览路径 | `ookla/speedtest/speedtest.yaml` |
| 语义规则数量 | **5** |
...
| Icon Identity | `brand.speedtest` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **Speedtest 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/ookla/speedtest/speedtest.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ookla/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `ookla_aggregate` / Ookla | 服务集 / Provider 聚合 | 5 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ookla/README.md) |
| `speedtest` / Speedtest | 独立服务 | 5 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ookla/speedtest/README.md) |
...
- **egern**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/egern/ookla/speedtest/speedtest.yaml`
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/ookla/speedtest/speedtest.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/ookla/speedtest/speedtest.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/ookla/speedtest/speedtest.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/ookla/speedtest/speedtest.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/ookla/speedtest/speedtest.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/ookla/speedtest/speedtest.list`
...
rule-providers:
  speedtest:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/ookla/speedtest/speedtest.yaml"
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/speedtest.png" alt="Speedtest icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `b6776246e5b90168085840c513492f30faa96c8aa4ca416ad64d1337690b8d58` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/speedtest.png) |
