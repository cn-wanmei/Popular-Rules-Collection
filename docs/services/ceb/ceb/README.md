...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="China Everbright Bank 图标" width="72" height="72">
...
| 项目 | 当前值 |
|---|---|
| 显示名称 | **China Everbright Bank** |
| Service ID | `ceb` |
| 类型 | 独立服务 |
| Provider / 服务集 | `ceb` |
| 规则浏览路径 | `ceb/ceb/ceb.yaml` |
| 语义规则数量 | **15** |
...
这是 **China Everbright Bank 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/ceb/ceb/ceb.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ceb/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `ceb_aggregate` / China Everbright Bank | 服务集 / Provider 聚合 | 15 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ceb/README.md) |
| `ceb` / China Everbright Bank | 独立服务 | 15 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/ceb/ceb/README.md) |
...
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/ceb/ceb/ceb.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/ceb/ceb/ceb.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/ceb/ceb/ceb.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/ceb/ceb/ceb.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/ceb/ceb/ceb.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/ceb/ceb/ceb.list`
...
rule-providers:
  ceb:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/ceb/ceb/ceb.yaml"
    path: ./ruleset/ceb.yaml
    interval: 86400
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="China Everbright Bank icon" width="56" height="56">
