...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="developer 图标" width="72" height="72">
...
| 类型 | 规则聚合 |
| Provider / 服务集 | — |
| 规则浏览路径 | `aggregate/developer/developer.yaml` |
| 语义规则数量 | **684** |
| 语义 SHA-256 | `db3a26a45a3f708b7a9d6ce59f1931bfd9d22a47a2e00b04c80efc98177ad801` |
...
这是 **developer** 的规则聚合，具体匹配范围以当前规则文件为准。
...
当前规则文件：
```text
rule/aggregate/developer/developer.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/aggregate/README.md)
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="developer icon" width="56" height="56">
