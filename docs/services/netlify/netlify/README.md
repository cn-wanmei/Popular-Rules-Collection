...
| Service ID | `netlify` |
| 类型 | 独立服务 |
| Provider / 服务集 | `netlify` |
| 规则浏览路径 | `netlify/netlify/netlify.yaml` |
| 语义规则数量 | **10** |
...
| Icon Identity | `brand.netlify` |
| Icon Role | `service` |
| Icon Release | `2026.09.22-5e0e48ad55c6` |

## 2. 规则用途

这是 **Netlify 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/netlify/netlify/netlify.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/netlify/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `netlify_aggregate` / Netlify | 服务集 / Provider 聚合 | 10 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/netlify/README.md) |
| `netlify` / Netlify | 独立服务 | 10 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/netlify/netlify/README.md) |
...
- **egern**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/egern/netlify/netlify/netlify.yaml`
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/netlify/netlify/netlify.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/netlify/netlify/netlify.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/netlify/netlify/netlify.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/netlify/netlify/netlify.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/netlify/netlify/netlify.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/netlify/netlify/netlify.list`
...
rule-providers:
  netlify:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/netlify/netlify/netlify.yaml"
    path: ./ruleset/netlify.yaml
    interval: 86400

rules:
  - RULE-SET,netlify,PROXY
```
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/netlify.png" alt="Netlify icon" width="56" height="56">
...
| Icon Release | `2026.09.22-5e0e48ad55c6` |
| Icon Digest | `070ae1296802d73bb43fd3f96bc6dbb226fa99a3f33f15bde350f3817ecb3763` |
| Icon Raw | [打开](https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/netlify.png) |
