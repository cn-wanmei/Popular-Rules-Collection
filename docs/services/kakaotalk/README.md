...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="KakaoTalk 图标" width="72" height="72">
...
| 类型 | 服务集 / Provider 聚合 |
| Provider / 服务集 | `kakaotalk` |
| 规则浏览路径 | `kakaotalk/kakaotalk.yaml` |
| 语义规则数量 | **15** |
...
这是 **KakaoTalk 服务集的聚合规则**，用于一次覆盖该服务集当前已登记的相关规则。需要更精确分流时，应直接使用下方独立子服务，而不是手工拆分聚合文件。
...
当前规则文件：
```text
rule/kakaotalk/kakaotalk.yaml
```

这是顶级服务集 **kakaotalk** 的入口，共 2 个已登记规则条目。

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `kakaotalk_aggregate` / KakaoTalk | 服务集 / Provider 聚合 | 15 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/kakaotalk/README.md) |
| `kakaotalk` / KakaoTalk | 独立服务 | 15 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/kakaotalk/kakaotalk/README.md) |
...
- **egern**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/egern/kakaotalk/kakaotalk.yaml`
- **loon**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/loon/kakaotalk/kakaotalk.list`
- **mihomo**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/kakaotalk/kakaotalk.yaml`
- **quantumultx**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/quantumultx/kakaotalk/kakaotalk.list`
- **shadowrocket**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/shadowrocket/kakaotalk/kakaotalk.list`
- **singbox**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/singbox/kakaotalk/kakaotalk.json`
- **surge**：`https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/surge/kakaotalk/kakaotalk.list`
...
rule-providers:
  kakaotalk_aggregate:
    ...
    behavior: classical
    format: yaml
    url: "https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/generated/mihomo/kakaotalk/kakaotalk.yaml"
    path: ./ruleset/kakaotalk_aggregate.yaml
    interval: 86400

rules:
  - RULE-SET,kakaotalk_aggregate,PROXY
```
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="KakaoTalk icon" width="56" height="56">
