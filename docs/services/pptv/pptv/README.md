...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="PPTV 图标" width="72" height="72">
...
这是 **PPTV 的独立服务规则**，可以作为独立远程规则集使用，不要求客户端同时加载其他同集服务。
...
当前规则文件：
```text
rule/pptv/pptv/pptv.yaml
```

所属服务集：[打开服务集](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/pptv/README.md)

| 同服务集条目 | 类型 | 规则数 | 文档 |
|---|---|---:|---|
| `pptv_aggregate` / PPTV | 服务集 / Provider 聚合 | 19 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/pptv/README.md) |
| `pptv` / PPTV | 独立服务 | 19 | [打开](https://github.com/cn-wanmei/Popular-Rules-Collection/blob/main/docs/services/pptv/pptv/README.md) |
...
<img src="https://raw.githubusercontent.com/cn-wanmei/Popular-Rules-Collection/main/assets/icons/v3/releases/2026.09.22-5e0e48ad55c6/clients/mihomo/128/placeholder.png" alt="PPTV icon" width="56" height="56">
