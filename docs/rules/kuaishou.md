...
|------|------|
| Rule ID | `kuaishou` |
| Primary Ecosystem | `kuaishou` |
| Service Type | aggregate |
| Parent Aggregate | `china` |
| Dedicated client outputs | 7 / 7 |
| Current State | candidate / review-required |

## 当前生产订阅路径

- `egern/kuaishou/kuaishou/kuaishou.yaml`
- `loon/kuaishou/kuaishou/kuaishou.list`
- `mihomo/kuaishou/kuaishou/kuaishou.yaml`
- `quantumultx/kuaishou/kuaishou/kuaishou.list`
- `shadowrocket/kuaishou/kuaishou/kuaishou.list`
- `singbox/kuaishou/kuaishou/kuaishou.json`
- `surge/kuaishou/kuaishou/kuaishou.list`
