...
This replaces the production role of the legacy ``scripts/normalize.py``.
It only converts parser output into V3 record conventions; it never writes the
legacy database/services tree and never depends on the V2 runtime.
"""
