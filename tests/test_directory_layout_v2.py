...
def test_provider_paths():
    assert EntityPathResolver.human_provider("12306").as_posix() == "rule/12306/12306/12306.yaml"
...
def test_generated_paths():
    assert EntityPathResolver.generated_provider("mihomo", "apple").as_posix() == "generated/mihomo/apple/apple/apple"
